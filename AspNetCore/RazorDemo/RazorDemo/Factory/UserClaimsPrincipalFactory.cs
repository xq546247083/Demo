    ...
    where TUser : class
{
    ...
    public RazorDemoUserClaimsPrincipalFactory(
    ...
    where TRole : class
{
    ...
    public RazorDemoUserClaimsPrincipalFactory(UserManager<TUser> userManager, RoleManager<TRole> roleManager, IOptions<IdentityOptions> options)
        : base(userManager, options)
    {
        ThrowIfNull(roleManager);
